            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Section(header: "2. Information We Collect") {
                        ...
                        Section(header: "3. Use of Information") {
                            VStack(alignment: .leading, spacing: 12) {
                        ...
                        Section(header: "4. Data Protection") {
                        ...
                        Section(header: "5. Third-Party Disclosure") {
                        ...
                        Section(header: "7. Cookies and Tracking") {
        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        Section(header: "1. Agreement to Terms") {
                        ...
                        Section(header: "5. Accuracy of Materials") {
                        ...
                        Section(header: "7. Modifications") {
                        ...
                        Section(header: "8. Governing Law") {
                        ...
                        Section(header: "9. User Accounts") {
                        ...
                        Section(header: "10. Prohibited Conduct") {
                            VStack(alignment: .leading, spacing: 12) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Section(header: "2. Accessibility Features") {
                            VStack(alignment: .leading, spacing: 12) {
                        ...
                        Section(header: "3. WCAG Compliance") {
                        ...
                        Section(header: "5. Report Accessibility Issues") {
